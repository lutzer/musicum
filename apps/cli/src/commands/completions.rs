...
const SLUG_COMPLETIONS: &[SlugCompletion] = &[
    ...
    SlugCompletion { path: &["clip", "list"],                   arg_index: 0, types: "file" },
    SlugCompletion { path: &["clip", "show"],                   arg_index: 0, types: "clip" },
    SlugCompletion { path: &["clip", "create"],                 arg_index: 0, types: "file" },
    SlugCompletion { path: &["clip", "apply-preset"],           arg_index: 0, types: "clip" },
    SlugCompletion { path: &["clip", "apply-preset"],           arg_index: 1, types: "preset" },
    SlugCompletion { path: &["clip", "clear-processors"],       arg_index: 0, types: "clip" },
    SlugCompletion { path: &["clip", "edit"],                   arg_index: 0, types: "clip" },
    SlugCompletion { path: &["clip", "set-notes"],              arg_index: 0, types: "clip" },
    SlugCompletion { path: &["clip", "delete"],                 arg_index: 0, types: "clip" },
    SlugCompletion { path: &["collection", "show"],             arg_index: 0, types: "collection" },
    SlugCompletion { path: &["collection", "set-description"],  arg_index: 0, types: "collection" },
    SlugCompletion { path: &["collection", "delete"],           arg_index: 0, types: "collection" },
    SlugCompletion { path: &["collection", "add-clip"],         arg_index: 0, types: "collection" },
    SlugCompletion { path: &["collection", "add-clip"],         arg_index: 1, types: "clip" },
    SlugCompletion { path: &["collection", "remove-clip"],      arg_index: 0, types: "collection" },
    SlugCompletion { path: &["collection", "remove-clip"],      arg_index: 1, types: "clip" },
    SlugCompletion { path: &["preset", "show"],                 arg_index: 0, types: "preset" },
    SlugCompletion { path: &["preset", "delete"],               arg_index: 0, types: "preset" },
    SlugCompletion { path: &["preset", "edit"],                 arg_index: 0, types: "preset" },
    SlugCompletion { path: &["preset", "add-processor"],        arg_index: 0, types: "preset" },
    SlugCompletion { path: &["preset", "remove-processor"],     arg_index: 0, types: "preset" },
    SlugCompletion { path: &["file", "show"],                   arg_index: 0, types: "file" },
